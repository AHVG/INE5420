...
class DisplayFile:
    ...
    def __init__(self):
        self.objects = [
            Point("First", [(0, 0, 100)], "#f00"),
            Line("Second", [(0, 0, 0), (90, 90, 0)], "#0f0"),
            ...
            # Transformation3D(BSpline("Circulo", control_points=[(-15 + 60, 15, 0), (0 + 60, 20, 0), (15 + 60, 15, 0), (20 + 60, 0, 0), (15 + 60, -15, 0), (60, -20, 0), (-15 + 60, -15, 0), (-20 + 60, 0, 0), (-15 + 60, 15, 0), (60, 20, 0), (15 + 60, 15, 0)], color="#000")).rotation_relative_to_axis(4, (0,1,0), (0,0,0)).apply()
            Wireframe(
                "Cube", 
                [
                    (-20, -20, -20),  # Base inferior
                    (20, -20, -20),
                    (20, 20, -20),
                    (-20, 20, -20),
                    (-20, -20, 20),  # Base superior
                    (20, -20, 20),
                    (20, 20, 20),
                    (-20, 20, 20)
                ],
                "#00f",  # Cor azul
                is_solid=False  # Não preencher como sólido
            )
        ]
