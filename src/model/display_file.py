...
class DisplayFile:
    ...
    def __init__(self):
        self.objects = [
            ...
            Curve2D("Teste Curva", control_points=[(10.0,0.0), (10.0,50.0), (60.0,50.0), (60.0,0.0), (60.0,-50.0), (110.0,0.0), (130.0,80.0), (160.0,30.0), (130.0,80.0), (50.0,-100.0), (130.0,80.0), (-150.0,-100.0)], color="#f00")
        ]
